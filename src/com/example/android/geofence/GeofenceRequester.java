...
public class GeofenceRequester
    ...
    private void continueAddGeofences() {
        ...
        Log.d(this.getClass().getName(), "continueAddGeofences");
    }
    ...
    public void onAddGeofencesResult(int statusCode, String[] geofenceRequestIds) {
	        ...
	        if (LocationStatusCodes.SUCCESS == statusCode) {
	            ...
	            msg = mContext.getString(R.string.add_geofences_result_success,Arrays.toString(geofenceRequestIds));
	        	}
    ...
    private PendingIntent createRequestPendingIntent() {
    	Log.d(this.getClass().getName(), "createRequestPendingIntent()");
        ...
        // If no PendingIntent exists
        	...
        	if(mActivity!=null){
        		...
        		Log.v("INTENT", "ARRIVED AT INTENT CREATION");
